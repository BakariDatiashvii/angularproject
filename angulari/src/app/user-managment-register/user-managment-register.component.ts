...
@Component({
  selector: 'app-user-managment-register',
  standalone: true,
  imports: [    CommonModule,
    ...
    InputTextModule,
    NgIf],
  templateUrl: './user-managment-register.component.html',
  styleUrl: './user-managment-register.component.css'
})
export class UserManagmentRegisterComponent {
